...
public class Sql {
    ...
    public Sql(String url, String username, String password, boolean devmode) {
    ...
    private void init() {
        con = DbConnectionUtil.getConnection(url, username, password);
        pstmt = null;
        rs = null;
    }
    ...
    private void close() {
        DbConnectionUtil.closeDb(con, pstmt, rs);
    }
